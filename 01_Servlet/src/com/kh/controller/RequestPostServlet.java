...
//		System.out.println("잘 실행되니...?");
		...
		request.setCharacterEncoding("UTF-8"); // 반드시 추가해 줘야함.
		...
		// 위의 요청처리를 다 했다는 가정하에 사용자가 보게 될 응답페이지 출력
		
		// 순수 Servlet 방식 : Java 소스코드내에 HTML을 작성
		// JSP(Java Server Page) : html내에 Java코드를 쓸 수 있는 기술
		
		// 응답페이지를 만드는 과정을 jsp에게 위임함.
		
		// 단, 그 응답화면(jsp)에서 필요로 하는 데이터들을 request 객체에 담아서 보내줘야함.
